...
def summarize_document():
    """Summarize uploaded document using Gemini AI"""
    try:
        ...
        summary, success = gemini_reply_from_history([], summary_prompt)
...
def legal_notice_generator():
    ...
    try:
        ...
        # Generate notice using Gemini
        notice_content, success = gemini_reply_from_history([], prompt)
...
def document_drafting():
    ...
    try:
        ...
        document_content, success = gemini_reply_from_history([], prompt)
